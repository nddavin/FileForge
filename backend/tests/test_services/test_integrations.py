...
class TestWebhookPayload:
    ...
    def test_payload_to_dict(self):
        ...
        payload = WebhookPayload(
            event_type=WebhookEventType.WORKFLOW_COMPLETED, data={"workflow_id": "wf-1"}
        )
    ...
    def test_payload_to_json(self):
        ...
        payload = WebhookPayload(
            event_type=WebhookEventType.FILE_UPLOADED, data={"filename": "test.pdf"}
        )
...
class TestWebhookService:
    ...
    def test_update_subscription(self):
        ...
        updated = self.webhook_service.update_subscription(
            subscription.id, name="Updated Name", active=False
        )
    ...
    def test_register_handler(self):
        ...
        self.webhook_service.register_handler(WebhookEventType.FILE_PROCESSED, handler)

        assert WebhookEventType.FILE_PROCESSED in self.webhook_service._event_handlers
        assert (
            handler
            in self.webhook_service._event_handlers[WebhookEventType.FILE_PROCESSED]
        )
    ...
    def test_emit_triggers_handler(self):
        ...
        payload = WebhookPayload(
            event_type=WebhookEventType.FILE_PROCESSED, data={"test": "data"}
        )
...
class TestIntegrationResult:
    ...
    def test_create_success_result(self):
        ...
        result = IntegrationResult(success=True, data={"id": "123"}, status_code=200)
    ...
    def test_create_error_result(self):
        ...
        result = IntegrationResult(
            success=False, error="Connection failed", status_code=500
        )
...
class TestConnectors:
    ...
    def test_docusign_connector_properties(self):
        ...
        config = IntegrationConfig(
            ...
            credentials={"integration_key": "test-key", "secret_key": "test-secret"},
        )
