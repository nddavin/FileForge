...
class Role(Base):
    ...
    created_at: Mapped[str] = mapped_column(
        DateTime, default=lambda: datetime.now(timezone.utc).isoformat()
    )
...
class AuditLog(Base):
    ...
    )  # login, logout, upload, delete, etc.
...
DEFAULT_PERMISSIONS = [
    ...
    },
    {
        ...
        "resource": "files",
        "action": "read",
        "description": "View all files in system",
    },
    {
        "name": "files:delete_all",
        "resource": "files",
        "action": "delete",
        "description": "Delete any file",
    },
    {
        "name": "files:manage_sharing",
        "resource": "files",
        "action": "update",
        "description": "Manage file sharing settings",
    },
    # Users
    {
        "name": "users:view",
