...
class Dynamics365Connector(IntegrationBase):
    ...
    def update_contact(self, contact_id: str, data: Dict[str, Any]) -> IntegrationResult:
    ...
    def upload_file(self, entity: str, entity_id: str, file_data: Dict[str, Any]) -> IntegrationResult:
        """Upload a file to an entity"""
        return self.send(
            f"/{entity}({entity_id})/annotation",
            file_data,
            "POST"
        )
