...
class RetentionPolicy:
    ...
    def should_apply(
        self, classification: DataClassification, jurisdiction: str
    ) -> bool:
...
class ComplianceService:
    ...
    def set_data_residency(
        self, classification: DataClassification, allowed_jurisdictions: List[str]
    ):
    ...
    def check_data_residency(
        ...
        can_transfer = (
            current_jurisdiction == target_jurisdiction
            or current_jurisdiction in allowed
        )
    ...
    def check_consent(
        self, user_id: str, purpose: str, jurisdiction: str
    ) -> Dict[str, Any]:
        ...
        for consent in reversed(user_consents):
            if (
                ...
                and consent.jurisdiction == jurisdiction
    ...
    def withdraw_consent(
        self, user_id: str, purpose: str, withdrawal_method: str
    ) -> bool:
    ...
    def validate_saml_assertion(
        self, saml_response: str, provider: str
    ) -> Dict[str, Any]:
    ...
    def generate_compliance_report(
        self, standard: ComplianceStandard, start_date: str, end_date: str
    ) -> Dict[str, Any]:
        """Generate compliance report for a standard"""
        audit_events = self.query_audit_log(start_time=start_date, end_time=end_date)
        ...
        return {
            ...
            "by_classification": self._aggregate_by_field(
                audit_events, "classification"
            ),
